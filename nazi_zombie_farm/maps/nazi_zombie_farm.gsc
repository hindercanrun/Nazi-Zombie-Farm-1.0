...
main()
{
	...
	level.DLC3.introString = "Nazi Zombie Farm";
	...
	zones[ zones.size ] = "barn_zone";
	zones[ zones.size ] = "basement_zone";
	...
	iprintlnbold("Survive in the farmhouse for as long as you can!");
}
...
dlc3_zone_init()
{
	...
	*/
	...
	add_adjacent_zone( "start_zone",		"barn_zone",	"enter_start_barn" );
}
